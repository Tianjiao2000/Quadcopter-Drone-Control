classdef Quadcopter2 < handle
    ...
    methods
        ...
        function update(obj,t)
            ...
            % small error
            input = [force+0.01; force+0.01; force+0.01; force+0.01];
            % large error
            % input = [force+0.05; force+0.05; force+0.01; force+0.01];
